<x-app-layout>
    ...
    <div class="py-1">
        <div class="bg-white overflow-hidden sm:rounded-lg drop-shadow-md max-w-7xl mx-auto sm:px-3 lg:px-1 border-emerald-300">
            
<div class="flex h-full flex-col">
  <header class="flex flex-none items-center justify-between border-b border-gray-200 py-4 px-2">
    ...
    <div>
      <button type="button" class="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-6 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2">
        Export
      </button>
      <button x-data="{}" x-on:click="window.livewire.emitTo('edit-agenda','show')" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >Tambah Agenda</button>
